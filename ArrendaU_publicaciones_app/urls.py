...
urlpatterns = [
    ...
    path('publicacion/<int:publicacion_id>/resena/crear/', views.crear_resena, name='crear_resena'),
    path('publicacion/<int:publicacion_id>/reseñas/', views.obtener_resenas, name='obtener_resenas'),
    path('mis-resenas/', views.mis_resenas, name='mis_resenas'),
    path('publicacion/<int:publicacion_id>/coordenadas/', views.obtener_coordenadas, name='obtener_coordenadas'),
    path('publicacion/<int:publicacion_id>/verificar-postulacion/', views.verificar_postulacion_existente, name='verificar_postulacion'),
    path('publicacion/<int:publicacion_id>/info-contacto/', views.obtener_info_contacto, name='obtener_info_contacto'),
    path('postulacion/<int:postulacion_id>/expulsar/', views.expulsar_arrendatario, name='expulsar_arrendatario'),
    path('usuario/<int:usuario_id>/resenas/', views.obtener_resenas_usuario, name='obtener_resenas_usuario'),
    path('postulacion/<int:postulacion_id>/estado/', views.obtener_estado_postulacion, name='obtener_estado_postulacion'),
    path('postulacion/<int:postulacion_id>/ocultar/', views.ocultar_postulacion, name='ocultar_postulacion'),
]